...
export default function Home() {
  ...
  }, [connected, publicKey, contractAddress, email, selectedOption, sendTransaction])

  // Submit banner request (for both automatic and manual flows)
  const submitBannerRequest = useCallback(
    async (paymentSignature: string, manualPayment: boolean) => {
      ...
      try {
        ...
        if (!response.ok) {
          ...
          throw new Error(errorData.error || "Failed to submit banner request")
        }
    ...
    [contractAddress, bannerText, bannerDescription, email, telegram, selectedOption, logoFile, screenshotFiles],
  )
  ...
  const handleManualPaymentSubmit = useCallback(
    ...
    [manualPaymentSignature, contractAddress, email, selectedOption, submitBannerRequest],
  )
  ...
  const handleScreenshotsChange = useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleManualPaymentInstructions = useCallback(() => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 to-blue-900 text-white">
                  ...
                  <div className="mt-4">
                    ...
                    <ul className="list-disc ml-6 text-sm">
                      ...
                      <li>
                        ...
                        <a href="mailto:solbannerr@gmail.com" className="text-blue-400 underline">
                          solbannerr@gmail.com
                        </a>
                        .
                      </li>
                    </ul>
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div>
                      <label htmlFor="bannerDescription" className="block text-sm font-medium mb-1">
                        Banner Description <span className="text-yellow-400">(New!)</span>
                      </label>
                      <Textarea
                        ...
                        className="bg-gray-700 border-gray-600"
                        placeholder="Describe how you want your banner to look (colors, style, layout, etc.)"
                        rows={3}
                      />
                    </div>
                  </div>
      ...
      <footer className="container mx-auto px-4 py-8 mt-auto">
        <div className="border-t border-gray-700 pt-6 text-center text-gray-400 text-sm">
          ...
          <p className="mt-2">
            Contact:{" "}
            <a href="mailto:solbannerr@gmail.com" className="hover:text-blue-400">
              solbannerr@gmail.com
            </a>
          </p>
        </div>
